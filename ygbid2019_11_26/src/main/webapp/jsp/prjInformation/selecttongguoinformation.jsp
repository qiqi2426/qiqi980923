...
<div class="container">
    ...
    <form class="form-horizontal" method="post" action="<%=request.getContextPath()%>/addtenderingprj" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <select class="form-control" id="tenderingtypeid" name="tenderingtypename" readonly>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="titletext" name="title" value="${tenderingprj.title}" readonly>
            </div>
        </div>
        <div class="form-group">
            <label for="bodytext" class="col-sm-2 control-label">内容</label>
            <div class="col-sm-8">
                <textarea class="form-control" id="bodytext" rows="3" name="body" readonly>${tenderingprj.body}</textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="opentime" class="col-sm-2 control-label">开标时间</label>
            <div class="col-sm-8">
                <input type="date" class="form-control" name="opentime" id="opentime" value="${tenderingprj.opentime}" readonly>
            </div>
        </div>
        <div class="form-group">
            <label for="supplierendtime" class="col-sm-2 control-label">截止时间</label>
            <div class="col-sm-8">
                <input type="date" class="form-control" id="supplierendtime" readonly name="supplierendtime" value="${tenderingprj.supplierendtime}">
            </div>
        </div>
